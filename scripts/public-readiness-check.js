...
if (packageJson.scripts?.["launch:packet"] && fileText("scripts/generate-launch-packet.js").includes("Red Thread launch packet") && fileText("scripts/generate-launch-packet.js").includes("launch-packet.md") && fileText("scripts/generate-launch-packet.js").includes("does not include secret values") && fileText("scripts/generate-launch-packet.js").includes("External setup order") && fileText("scripts/generate-launch-packet.js").includes("PUBLIC_WRITE_PAUSED=true")) pass("launch packet npm script");
