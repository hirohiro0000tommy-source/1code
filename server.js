...
const discordLoginFlag = process.env.DISCORD_LOGIN_ENABLED ? envFlag(process.env.DISCORD_LOGIN_ENABLED) : true;
const discordLoginEnabled = discordLoginFlag || discordConfigState().ok;
